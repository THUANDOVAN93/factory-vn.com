...
<?php } ?>
			...
			<?php echo $this->Form->create('ContactFactory', array('id' => 'form', 'url' => '/contact/factory/complete')); ?>
				...
				<?php echo $this->Form->hidden('industry'); ?>
				...
				<?php echo $this->Form->hidden('boi_zone'); ?>
				<?php echo $this->Form->hidden('location'); ?>
				<?php echo $this->Form->hidden('factory_sub_category'); ?>
				<?php echo $this->Form->hidden('floor_space_site'); ?>
				<?php echo $this->Form->hidden('floor_space_building'); ?>
				<?php echo $this->Form->hidden('weight_limit'); ?>
				<?php echo $this->Form->hidden('building_height'); ?>
